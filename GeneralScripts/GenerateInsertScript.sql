...
CLOSE cursCol  
DEALLOCATE cursCol  
--Exec [InsertGenerator]   'DW_DIM_Product'

--INSERT DW_DIM_Product(ProductID,Name,Number,ProductFamily,PartCPC,CPC,Project,SegmentID,TargetMin,TargetMax,Cost)         VALUES('1','00351229','ADV-4005867001_SMT','ADV','ADV','ADV','ADVA','2','63.4','63.4','0')